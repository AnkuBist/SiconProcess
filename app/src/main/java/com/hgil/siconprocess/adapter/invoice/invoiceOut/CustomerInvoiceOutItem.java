...
import com.hgil.siconprocess.activity.fragments.customerInvoice.makeSaleInvoice.InvoiceOutFragment;
    ...
    public void updateInvoiceItem(final CustomerInvoiceOutAdapter.ViewHolder holder, final InvoiceModel itemInvoice, final int position) {
        ...
        etQty.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                String customerTotalInvoiceAmount = "Total\n" + strRupee + Utility.roundTwoDecimals(InvoiceOutFragment.grandTotal);
